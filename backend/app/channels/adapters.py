...
from app.channels.telegram import TelegramBotAdapter, TelegramProviderAdapter
...
class TelegramProviderAdapter(TelegramBotAdapter):
    """Backward-compatible alias for TelegramBotAdapter."""

    pass


class BaleProviderAdapter(TelegramBotAdapter):
