...
class Settings(BaseSettings):
    ...
    rabbitmq_legacy_queue_message_received: str = "instagram.message.received"
    rabbitmq_legacy_queue_retry: str = "instagram.message.received.retry"
    rabbitmq_legacy_queue_dlq: str = "instagram.message.received.dlq"
