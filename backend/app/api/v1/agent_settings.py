...
def get_agent_settings(shop_id: UUID, current_user: Annotated[User, Depends(get_current_user)], _membership: Annotated[ShopMember, Depends(get_shop_membership)], db: Annotated[Session, Depends(get_db_session)]) -> ShopAgentStudioSettingsRead:
...
def put_agent_settings(shop_id: UUID, payload: ShopAgentStudioSettingsUpdate, current_user: Annotated[User, Depends(get_current_user)], _membership: Annotated[ShopMember, Depends(get_shop_membership)], db: Annotated[Session, Depends(get_db_session)]) -> ShopAgentStudioSettingsRead:
...
def get_studio_settings(shop_id: UUID, current_user: Annotated[User, Depends(get_current_user)], _membership: Annotated[ShopMember, Depends(get_shop_membership)], db: Annotated[Session, Depends(get_db_session)]) -> ShopAgentStudioSettingsRead:
    return AgentSettingsService(db).get_or_create(shop_id, current_user)


@router.patch("/agent-studio-settings", response_model=ShopAgentStudioSettingsRead)
def patch_studio_settings(shop_id: UUID, payload: ShopAgentStudioSettingsUpdate, current_user: Annotated[User, Depends(get_current_user)], _membership: Annotated[ShopMember, Depends(get_shop_membership)], db: Annotated[Session, Depends(get_db_session)]) -> ShopAgentStudioSettingsRead:
    return AgentSettingsService(db).update(shop_id, payload, current_user)
