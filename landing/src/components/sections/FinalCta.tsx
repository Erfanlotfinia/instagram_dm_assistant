  ...
  return (
    <section id={finalCta.id} className="relative overflow-hidden py-24 sm:py-32">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute start-1/2 top-1/2 size-[560px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-modira-cyan/15 blur-[130px]" />
      </div>
      <Container>
        <div className="glass-strong relative mx-auto max-w-3xl overflow-hidden rounded-3xl p-8 text-center sm:p-12">
          ...
          <h2 className="mt-6 text-2xl font-extrabold leading-tight text-fg sm:text-4xl">
            ادمین شبکه‌های اجتماعی خود را <GradientText>هوشمند</GradientText> کنید
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-fg/80">
            {finalCta.text}
          </p>
