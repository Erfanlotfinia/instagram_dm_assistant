...
Core runtime variables configure databases, Redis, RabbitMQ, Qdrant, JWT, CORS, LLM providers, and browser-safe frontend URLs. Channel secrets belong in encrypted per-shop channel account records, not in `.env` files.
